...
namespace edu.mines.jtk.awt
{
    public class ColorMap
    {
        ...
        */
        public static readonly IndexColorModel GRAY = getGray();

        /**
        * Color model for red to blue like Matlab's jet color map.
        */
        public static readonly IndexColorModel JET = getJet();

        /**
        * Color model for red to blue like GMT's jet color map.
        */
        public static readonly IndexColorModel GMT_JET = getGmtJet();

        /**
        * Color model for hues from red to blue. 
        */
        public static readonly IndexColorModel HUE = getHue();

        /**
        * Color model for hues from red to blue. 
        */
        public static readonly IndexColorModel HUE_RED_TO_BLUE = getHueRedToBlue();

        /**
        * Color model for hues from blue to red. 
        */
        public static readonly IndexColorModel HUE_BLUE_TO_RED = getHueBlueToRed();

        /**
        * Color model for eight complete cycles of hues.
        */
        public static readonly IndexColorModel PRISM = getPrism();

        /**
        * Color model for red to white to blue.
        */
        public static readonly IndexColorModel RED_WHITE_BLUE = getRedWhiteBlue();

        /**
        * Color model for blue to white to red.
        */
        public static readonly IndexColorModel BLUE_WHITE_RED = getBlueWhiteRed();

        /**
        * Color model for gray to yellow to red.
        */
        public static readonly IndexColorModel GRAY_YELLOW_RED = getGrayYellowRed();
        ...
        */
        public int getIndex(double v) {
            const double Math_ulp_256 = 5.6843418860808015E-14;
        v = Math.Max(_vmin,Math.Min(_vmax,v));
        double s = (256.0-Math_ulp_256)/(_vmax-_vmin);
